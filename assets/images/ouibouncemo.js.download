    ...
    function addModal() {
        ...
        $(document).ready(function() {
            ...
            var svg = document.getElementById('svg-id');
                ...
                var headerId = document.getElementById('ubheader');
                var paragraphId = document.getElementById('ubparagraph');
                // get the inner element by id
                headerId.innerHTML  = headerTranslation;
                paragraphId.innerHTML  = paragraphTranslation;
        });
